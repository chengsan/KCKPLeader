...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        self.todayChartV = [[UIImageView alloc]initWithFrame:CGRectMake(20, self.center.y-chartWidth/1.4, chartWidth+10, chartWidth+10) ];
        ...
        self.todayLab = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, chartWidth, 18)];
        ...
        self.todayAverage = [[UILabel alloc]initWithFrame:CGRectMake(_todayChartV.frame.origin.x, CGRectGetMaxY(_todayChartV.frame)+5, chartWidth, 15)];
        self.todayAverage.text = @"当天平均时效";
        [self.todayAverage sizeToFit];
        self.todayAverage.font = [UIFont systemFontOfSize:12];
        [self addSubview:_todayAverage];
        
        self.weekChartV = [[UIImageView alloc]initWithFrame:CGRectMake(40+chartWidth, _todayChartV.frame.origin.y, chartWidth+10, chartWidth+10) ];
        self.weekChartV.image = [UIImage imageNamed:@"icon222"];
        [self addSubview:self.weekChartV];
        
        self.weekLab = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, chartWidth, 18)];
        ...
        self.weekAverage = [[UILabel alloc]initWithFrame:CGRectMake(_weekChartV.frame.origin.x, CGRectGetMaxY(_weekChartV.frame)+5, chartWidth, 15)];
        self.weekAverage.text = @"本周平均时效";
        [self.weekAverage sizeToFit];
        self.weekAverage.font = [UIFont systemFontOfSize:12];
        [self addSubview:_weekAverage];
        
        self.monthChartV = [[UIImageView alloc]initWithFrame:CGRectMake(60+2*chartWidth, _todayChartV.frame.origin.y, chartWidth+10, chartWidth+10) ];
        self.monthChartV.image = [UIImage imageNamed:@"icon333"];
        [self addSubview:self.monthChartV];
        
        self.monthLab = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, chartWidth, 18)];
        ...
        self.monthAverage = [[UILabel alloc]initWithFrame:CGRectMake(_monthChartV.frame.origin.x, CGRectGetMaxY(_monthChartV.frame)+5, chartWidth, 15)];
        self.monthAverage.text = @"本月平均时效";
        [self.monthAverage sizeToFit];
